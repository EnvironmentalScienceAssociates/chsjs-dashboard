waterQualityUI <- function(id) {
  ...
  layout_sidebar(
    sidebar = sidebar(
      ...
      conditionalPanel(
        condition = 'input.panel != "Tile Plot" && input.panel != "Scatter Plot"',
        selectInput(
      ...
      conditionalPanel(
        condition = 'input.panel == "Scatter Plot"',
        selectInput(
      ...
      conditionalPanel(
        condition = 'input.panel == "Bar Plot" | input.panel == "Tile Plot" | input.panel == "Map"',
        selectInput(
          inputId = ns("stat"),
          "Statistic",
          choices = c("Minimum", "Median", "Maximum"),
          selected = "Median"
        ),
        ns = NS(id)
      ),
