options(dplyr.summarise.inform = FALSE, shiny.autoreload = TRUE)
...
wq_raw = readRDS(file.path("data", "wqall.rds"))
...
elements = c("Routine", "Groundwater", "TS Debby", "Tracer")
